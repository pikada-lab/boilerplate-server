...
export class PhotoModule {
  ...
  constructor(das: DataAccessService, server: ServerController, yc: YCService) {
    ...
    this.presenter = new PresenterComponent(this.imageService, this.photoComponent.getRepository());
